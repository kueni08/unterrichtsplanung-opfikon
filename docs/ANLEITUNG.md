...
- **Kinder umteilen (mit Prüfung)**: Ein Kind ist immer in genau einer Gruppe – seiner Stammgruppe. Für einzelne Lektionen („Kinder in dieser Lektion umteilen“ im Editor) oder für einen ganzen Tag („Kinder heute umteilen“ im Tagesfokus) lässt es sich vorübergehend einer anderen Gruppe zuteilen; die Lektion hat Vorrang vor dem Tag. Die App prüft dabei: Eine Gruppe, die in der Lektion „frei“ hat, ist als Ziel gesperrt; ist das Kind dort ohnehin schon, erscheint ein Hinweis statt eines doppelten Eintrags. Umgeteilte Lektionen tragen im Wochenplan ein „↔ n“-Kennzeichen, der Planungscheck meldet Umteilungen in Gruppen, die inzwischen frei haben. Teams ohne Stammliste warnt der Planungscheck, wenn dasselbe Kürzel in mehreren Gruppenlisten steht.
- **Vorschläge beim Tippen**: Fach- und Raumfelder zeigen beim Klick eine Auswahl (Fächer des Lehrplans plus alles, was im Team schon verwendet wird; Räume aus früheren Lektionen). Tippen filtert die Liste, Pfeiltasten/Enter wählen – freie Eingaben bleiben jederzeit möglich. Bei der Kinderzuordnung filtert das Suchfeld die Stammliste („pa“ → Patrick, Pascal …); die Auswahl trägt das Kürzel ein.
...
**E-Mail-Benachrichtigung:** Unten in der Liste „Was ist neu“ wählt jede Person selbst: **nie**, **sofort** bei jeder wichtigen Änderung anderer oder **täglich** eine Zusammenfassung (Mo–Fr gegen 17 Uhr, mit allem Wichtigen seit der letzten Zusammenfassung – auch vom Wochenende). Die Mail nennt wer/wann/was und enthält einen Link zum Wochenplan; Absender ist „Wochenatelier“. Kleine Änderungen (Notizen, Status) lösen nie eine Mail aus.
